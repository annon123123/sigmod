...
function run_beeline_print_usage {
    ...
    echo " --hdp                                  Connect to HDP HiveServer2."
    ...
    while [ "${1+defined}" ]; do
        case "$1" in
            ...
            --delete)
                ...
                ;;
            --hdp)
                HIVE_SERVER2_HOST_CUSTOM=$HIVE_SERVER2_HDP_HOST
                HIVE_SERVER2_PORT_CUSTOM=$HIVE_SERVER2_HDP_PORT
                HIVE_SERVER2_KERBEROS_PRINCIPAL_CUSTOM=$HIVE_SERVER2_HDP_KERBEROS_PRINCIPAL
                HIVE_SERVER2_JDBC_OPTS=$HIVE_SERVER2_HDP_JDBC_OPTS
                shift
                ;;
            *)
...
function run_beeline_start {
    ...
    declare ex_file="$run_dir/exceptions.txt"
