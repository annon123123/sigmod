...
public class ShuffleVertexManager extends ShuffleVertexManagerBase {
  ...
  ReconfigVertexParams computeRouting() {
    ...
    scala.Tuple2<int[], int[][]> mappingIndexes =
      mr3.api.common.Utils.distributeStats(currentStatsInMB, finalTaskParallelism);
    ...
    EdgeManagerPluginDescriptor descriptor =
        EdgeManagerPluginDescriptor.create(mr3.dag.MappingEdgeManager.class.getName());
  ...
  private ReconfigVertexParams computeParams(int currentParallelism, int finalTaskParallelism) {
    ...
    EdgeManagerPluginDescriptor descriptor =
        EdgeManagerPluginDescriptor.create(mr3.dag.DynamicScatterGatherEdgeManager.class.getName());
    descriptor.setUserPayload(UserPayload.create(buffer));
