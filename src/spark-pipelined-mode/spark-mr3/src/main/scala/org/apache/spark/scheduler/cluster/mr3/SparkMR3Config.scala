...
private[mr3] object SparkMR3Config {
  ...
  val SPARK_MR3_PIPELINED_SCHEDULE_SRC_FRACTION = "spark.mr3.pipelined.schedule.src.fraction"
  val SPARK_MR3_PIPELINED_SCHEDULE_SRC_FRACTION_DEFAULT = 1.0

  val SPARK_MR3_PIPELINED_NUM_FETCHES = "spark.mr3.pipelined.num.fetches"
  val SPARK_MR3_PIPELINED_NUM_FETCHES_DEFAULT = 2

  val RESERVED_CONFIG_KEYS = Seq(
      SPARK_MR3_APP_ID, SPARK_MR3_KEEP_AM, SPARK_MR3_CLIENT_CONNECT_TIMEOUT_MS,
      SPARK_MR3_DAG_STATUS_CHECKER_PERIOD_MS, SPARK_MR3_PIPELINED_SCHEDULE_SRC_FRACTION,
      SPARK_MR3_PIPELINED_NUM_FETCHES)
}
